@extends('user.app')
@section('content')
<div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/nike_5.jpg);" data-aos="fade">
    <div class="container">
    <div class="row align-items-start align-items-md-center justify-content-end">
        <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
        <h1 class="mb-2">Temukan Kebutuhan Olahragamu Di sini !</h1>
        <div class="intro-text text-center text-md-left">
            <p>
            <a href="{{ route('user.produk') }}" class="btn btn-sm btn-primary">Belanja Yuk</a>
            </p>
        </div>
        </div>
    </div>
...
<div class="site-section site-section-sm site-blocks-1">
    ...
    <div class="row">
        ...
        <div class="text">
            <h2 class="text-uppercase">Pelayanan</h2>
            <p>Pelayanan Cepat</p>
        </div>
        </div>
        ...
        <div class="text">
            ...
            <p>Kami menjamin harga yang ditawarkan terjangkau</p>
        </div>
        </div>
    </div>
    </div>
