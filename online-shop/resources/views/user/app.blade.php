...
<html lang="en">
  <head>
    <title>Cikini Sport &mdash; Toko Olahraga Online </title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="/" class="js-logo-clone">Cikini Sport</a>
              </div>
            </div>
                        ...
                        <li>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="{{ route('user.akun') }}">Pengaturan Akun</a>
    ...
    <footer class="site-footer border-top">
      <div class="container">
          ...
          <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="block-5 mb-5">
                  ...
                  <ul class="list-unstyled">
                    <li class="address">Jalan Pegangsaan Timur Nomor 1, Cikini Menteng Jakarta Pusat</li>
                    <li class="phone"><a href="tel://02139830077">(021) 39830077</a></li>
                    <li class="email">cikinisport@gmail.com</li>
                  </ul>
                </div>  
          </div>
        </div>
        <div class="row text-center">
          <div class="col-md-12">
            <p>
            Copyright @ 2021 Cikini Sport Center
            </p>
          </div>
