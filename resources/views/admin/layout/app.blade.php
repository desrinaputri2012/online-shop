...
<html lang="en">
  <head>
    ...
    <title>Cikini Sport Center</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="/admin"><img src="{{ asset('adminassets') }}/assets/images/logo2.png" alt="logo" height="50" /></a>
          <a class="navbar-brand brand-logo-mini" href="/admin"><img src="{{ asset('adminassets') }}/assets/images/logo-mini.png" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Admin Cikini Sport</p>
                </div>
              </a>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">Cikini Sport</span>
         ...
         @yield('content')
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright @ 2021 Cikini Sport Center</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
