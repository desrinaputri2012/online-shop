...
<div class="bg-light py-3">
    <div class="container">
    <div class="row">
        <div class="col-md-12 mb-0"><a href="/">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Detail Produk</strong></div>
    </div>
    </div>
</div>  
...
<div class="site-section">
    ...
    <div class="row">
        ...
        <div class="mb-5">
            <a href="{{ route('user.produk.review',['id' =>  $produk->id]) }}" class="buy-now btn btn-sm btn-primary">Review Produk</a>
